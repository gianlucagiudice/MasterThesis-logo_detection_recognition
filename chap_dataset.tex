...
\begin{figure}%
	\centering
	\subfloat[\centering Image \code{Others/avery dennison-1/27.jpg}]{{\includegraphics[width=0.45\textwidth]{images/image-27.jpg} }}%
	\hfill
	\subfloat[\centering Image \code{Others/avery dennison-2/56.jpg}]{{\includegraphics[width=0.45\textwidth]{images/image-56.jpg} }}%
